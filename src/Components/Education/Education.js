            ...
            <div>
                ...
                <div className="shadow p-3 mb-5 bg-white rounded edu-box">
                    <div className="resume-content">
                        <p className="mb-3 edu-info"><strong>BSc (Hons) in Information Technology Specialising in Software Engineering</strong></p>
                        <div className="mb-2 h5">Sri Lanka Institute of Information Technology - SLIIT</div>
                        <h6>GPA: 3.68</h6>
                ...
                <div className="shadow p-3 mb-5 bg-white rounded edu-box">
                    <div className="resume-content">
                        <p className="mb-3 edu-info"><strong>Rahula College - Matara</strong></p>
