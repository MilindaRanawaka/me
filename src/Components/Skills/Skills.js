...
export default class Skills extends Component {
  render() {
    return (
      <div>
        <h2>Skills</h2>
        <SkillCard icon={"fab fa-java"} name={"Java"} />
        ...
        <SkillCard icon={"fas fa-database"} name={"SQL"} />
        <SkillCard icon={"fab fa-php"} name={"PHP"} />
        <SkillCard icon={"fab fa-bootstrap"} name={"Bootstrap"} />
        <SkillCard icon={"devicon-git-plain"} name={"GIT"} />
        <SkillCard icon={"devicon-visualstudio-plain"} name={"Visual Studio"} />
        <SkillCard icon={"fab fa-npm"} name={"NPM"} />
        <SkillCard icon={"fas fa-fire-alt"} name={"FireBase"} />
        <SkillCard icon={"devicon-heroku-original"} name={"Heroku"} />
      </div>
    );
  }
}
