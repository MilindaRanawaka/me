        ...
        return (
            <div>
                ...
                <ProjectDiv
                    ...
                    desc={"Full-stack application for the Online Fashion Store system developed, making the use of REST API technologies"}
                    tech={"ReactJS | Node JS | HTML5 | CSS3 | Bootstrap | Express JS | MongoDB "}
                ...
                <ProjectDiv
                    ...
                    desc={"Global and Sri Lankan COVID-19 Tracker using API provided by Health Promotion Bureau"}
                    tech={"ReactJS | Node JS | HTML5 | CSS3 | Bootstrap | MySQL "}
                    gitLink={"https://github.com/MilindaRanawaka/Covid-19-Sri-Lanka-and-Global-Tracker"}
                    liveLink={"https://milindaranawaka.github.io/Covid-19-Sri-Lanka-and-Global-Tracker/"}
                />
                <ProjectDiv
                ...
                <ProjectDiv
                    ...
                    desc={"A mobile application to Management of a hostel (STAY). Function including Room Management, Boarder Management, Leave Management, Food Management, Payment Management"}
                ...
                <ProjectDiv
                    ...
                    desc={"A web-based system for Computer Shop for Manage their branches sales and stocks"}
